...
if (-not $env:WINPYDIR -eq [System.IO.Path]::GetFullPath( $env:WINPYDIRBASE+"\python-3.5.2.amd64") ) {


$env:WINPYDIR = $env:WINPYDIRBASE+"\python-3.5.2.amd64"


$env:WINPYVER = '3.5.2.3'
